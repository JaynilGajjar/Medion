			...
			<div class="container">
				<div class="top_contact-container">
					<div class="tel_container">
						<a href=""> <img src="images/telephone-symbol-button.png"
							alt=""> Call : +01 1234567890
						</a>
					</div>
						...
						<div
							...
							<div class="login_btn-contanier ml-0 ml-lg-3">
								...
								<div class="login_btn-contanier ml-0 ml-lg-3">
										...
										%>
										<a class="nav-link" href="wishlist.jsp">Wishlist<%if(count>0){ %>(<%=session.getAttribute("wishlist_count")%>)<%} %></a>
										<%
											int count1=Integer.parseInt(session.getAttribute("cart_count").toString());
										%>
										<a class="nav-link" href="cart.jsp">Cart<%if(count>0){ %>(<%=session.getAttribute("cart_count")%>)<%} %></a>
