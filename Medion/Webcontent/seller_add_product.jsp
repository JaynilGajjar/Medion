          ...
          %>
            <form method="post" action="ProductController" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <textarea rows="5" cols="20" class="form-control" id="address" name="product_desc" placeholder="Product Description"></textarea>
              </div>
              <div class="form-group">
                <label>Product Image</label>
                <input type="file" name="product_image" placeholder="Product name">
              </div>
              <button type="submit" name="action" value="Add Product" class="btn btn-primary">Register</button>
            </form>
          </div>
        </div>
