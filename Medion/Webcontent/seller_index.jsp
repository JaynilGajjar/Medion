							...
							<div class="row">
								...
								<div class="col-md-8">
									<div class="detail-box">
										<h1>
											Welcome To Our <br> <span> Online Medicine </span>
		...
		<div class="container">
			...
			<div class="detail-box">
				<p>It is a long established fact that a reader will be
					...
					'Content here, content here', making it</p>
				<div class="d-flex justify-content-center">
					<a href=""> Read More </a>
				</div>
			</div>
						...
						<div class="client_container layout_padding2">
							...
							<div class="client_box ">
								...
								<div class="name">
									<h5>Randomised</h5>
									<h6>
										<span> Client </span> <img src="images/quote.png" alt="">
									</h6>
								</div>
							</div>
						</div>
				...
				<div class="col-md-5">
					<div class="form_contaier">
						<form>
							...
							<div class="form-group">
								<label for="exampleInputNumber1">Phone Number</label> <input
							...
							<div class="form-group ">
								<label for="inputState">Select medicine</label> <select
							...
							<div class="form-group">
								<label for="exampleInputMessage">Message</label> <input
									type="text" class="form-control" id="exampleInputMessage">
							</div>
